<?php
class Application_Dao_WebflowPvStatisticsDAO extends Wavegoing_TableDAO{
	protected $_name='webflow_pv_statistics';
	
	/**
	 *
	 * @param integer $businessId        	
	 * @param string $statTime        	
	 * @return Application_Model_WebflowPvStatisticsModel
	 */
	...
	public function addMockCount($businessId, $statTime) {
		$entity=$this->getMockStatistics($businessId,$statTime);
		if($entity== null){
			$entity=new Application_Model_WebflowPvStatisticsModel();
	...
	/**
	 *
	 * @param Application_Model_WebflowPvStatisticsModel $entity        	
	...
	public function composeEntity($row) {
		$result=new Application_Model_WebflowPvStatisticsModel();
