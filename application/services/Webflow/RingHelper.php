 ...
 *
 */
class Application_Service_Webflow_RingHelper extends Application_Service_Webflow_MultiItemHelper{
    ...
    protected function composeItemPreChargeOutput($item){
        $this->appendPage($this->webflow->getOption1(),'/s3/^^">'.$item->getName().'</a>');
        $this->appendPage('http://m.10086.cn/s3/${v1}',"/s3/i/or/rt/^^'>快速下载MP3高潮版");
    }
